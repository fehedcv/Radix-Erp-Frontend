...
const AgentControlApp = () => {
  ...
  const chartConfigs = useMemo(() => {
    ...
    return {
      status: {
        ...
        options: {
          chart:       { id: 'status-donut', animations: { enabled: false } },
      ...
      performance: {
        ...
        options: {
          chart:        { id: 'performance-bar', toolbar: { show: false }, animations: { enabled: false } },
          colors:       ['#4F46E5'],
  ...
  return (
    <div className="font-['Plus_Jakarta_Sans',sans-serif] space-y-5 max-w-[1600px] mx-auto pt-[env(safe-area-inset-top)] pb-[calc(4rem+env(safe-area-inset-bottom))] px-4">
      ...
      {/* ── MODAL ── */}
        {selectedAgent && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] bg-slate-950/20 backdrop-blur-sm">
