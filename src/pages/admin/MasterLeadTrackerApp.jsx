...
const filteredLeads = useMemo(() => {
  ...
  return (
    <div className="font-['Plus_Jakarta_Sans',sans-serif] space-y-6 max-w-[1600px] mx-auto md:px-0 pt-[env(safe-area-inset-top)] pb-[calc(4rem+env(safe-area-inset-bottom))] px-4">

      {/* HEADER */}
      <div className="bg-white border border-slate-200 p-4 md:p-6 rounded-2xl shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
      ...
      {/* DETAIL PANEL */}
      {selectedLead && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6 pt-[calc(1rem+env(safe-area-inset-top))] pb-[calc(1rem+env(safe-area-inset-bottom))]">
          {/* Backdrop */}
          <div
