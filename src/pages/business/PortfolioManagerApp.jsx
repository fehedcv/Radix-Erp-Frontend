...
const PortfolioManagerApp = () => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] pt-[env(safe-area-inset-top)] pb-[calc(4rem+env(safe-area-inset-bottom))] font-['Plus_Jakarta_Sans',sans-serif]">
  ...
  return (
    <div className={`max-w-[1400px] mx-auto pt-[env(safe-area-inset-top)] pb-[calc(5rem+env(safe-area-inset-bottom))] space-y-6 font-['Plus_Jakarta_Sans'] px-2 sm:px-0 transition-colors duration-300 ${isLight ? 'text-[#1A1D1F]' : 'text-[#E2E8F0]'}`}>
      ...
      <AnimatePresence>
        {showPreview && (
          <motion.div
            ...
            className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex justify-center items-center p-4 pt-[calc(1rem+env(safe-area-inset-top))] pb-[calc(1rem+env(safe-area-inset-bottom))]"
