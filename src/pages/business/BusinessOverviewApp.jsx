...
const BusinessOverviewApp = () => {
  ...
  return (
    <div className={`font-['Plus_Jakarta_Sans',sans-serif] space-y-6 pt-[env(safe-area-inset-top)] pb-[calc(5rem+env(safe-area-inset-bottom))] transition-colors duration-300 ${isLight ? 'text-[#1A1D1F]' : 'text-[#E2E8F0]'}`}>
