...
const AgentHub = ({ onLogout }) => {
  ...
  return (
    <div
      className={`flex h-[100dvh] font-['Plus_Jakarta_Sans',sans-serif] overflow-hidden transition-colors duration-300 ${
    ...
    >
      ...
      {/* 1. DESKTOP SIDEBAR */}
      <aside
        className={`hidden lg:flex flex-col w-[260px] h-full shrink-0 relative transition-colors duration-300 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] ${
          theme === 'light' ? 'bg-[#5B6777]' : 'bg-[#1A202C]'
        }`}
      >
      ...
      {/* MAIN AREA */}
      <main className={`flex-1 flex flex-col min-w-0 h-full lg:py-3 lg:pr-3 overflow-hidden relative z-10 transition-colors duration-300 pt-[env(safe-area-inset-top)]`}>
        <div className={`w-full h-full flex flex-col relative overflow-hidden transition-colors duration-300 ${
          ...
          {/* CONTENT */}
          <div className="flex-1 overflow-y-auto no-scrollbar pb-[calc(5rem+env(safe-area-inset-bottom))] lg:pb-0 relative">
          ...
          <button
            ...
            className={`lg:hidden fixed bottom-[calc(90px+env(safe-area-inset-bottom))] right-5 w-14 h-14 rounded-full flex items-center justify-center z-40 shadow-[0_8px_30px_rgba(0,0,0,0.3)] active:scale-90 transition-all ${
              theme === 'light'
      ...
      {/* MOBILE NAV */}
      <nav className={`lg:hidden fixed bottom-0 left-0 right-0 z-50 flex justify-around items-center px-4 pb-[env(safe-area-inset-bottom)] pt-2 h-[calc(72px+env(safe-area-inset-bottom))] rounded-t-[24px] transition-colors duration-300 ${
        theme === 'light'
      ...
      <AnimatePresence>
        {showLogoutConfirm && (
          <div className="fixed inset-0 z-[500] flex items-center justify-center p-4 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] bg-black/50 backdrop-blur-sm">
            <motion.div
